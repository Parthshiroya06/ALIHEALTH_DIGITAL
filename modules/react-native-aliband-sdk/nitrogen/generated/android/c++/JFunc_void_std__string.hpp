...
namespace margelo::nitro::alibandsdk {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/alibandsdk/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/alibandsdk/Func_void_std__string_cxx;";
